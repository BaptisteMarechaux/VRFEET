...
public class VersusAsyncController : MonoBehaviour {
	...
	void Start ()
    {
        goalKeeper = Instantiate(goalKeeperPrefab, goalSpawn.position, goalSpawn.rotation) as GameObject;
        Reset();
	}
